...
<template>
    <div class=" print-leave d-none d-print-block row">
       <div class="print-header fw-bold">
           ...
           <div class="cap">(Level II Administrators)</div>
       </div>
       ...
       <div class="print-body">
           ...
           <div class="line-2 d-flex">
            ...
            <div class="line-9">
                <div class="list-endorse ms-4">
                    <div class="first-line d-flex">
                        ...
                        <div class="line-content ps-2">
                            {{ checkBalance(leave_data.leave_id) }}
                        </div>
            ...
            <div class="note mt-3 mb-5">
                <div class="text-center note-cap m-0">
                        (Note: Leave Balance should be provided by the HR Office)
                </div>
                   
            </div>
            <div class="line-8 mb-2">
                <div class="endorse-content">
             ...
             <div class="line-9">
                <div class="list-endorse">
                    <div class="first-line d-flex">
                        ...
                        <div class="line-cap">Approved with pay </div>
                    </div>
                    <div class="first-line d-flex">
                        <div class="line-content text-center">
                             <i   v-if="leave_data.status == 2"  class="bi bi-check text-danger fw-bold"></i>
                        </div>
                        <div class="line-cap">Approved without pay </div>
                    </div>
                    <div class="first-line d-flex">
                        <div class="line-content text-center">
                             <i v-if="leave_data.status == 3" class="bi bi-check text-danger fw-bold"></i>
                        </div>
                        <div class="line-cap"> Disapproved because </div>
                        <div class="line-content-longp ps-2"> {{leave_data.remarks }}</div>
                    </div>
                </div>
             </div>
             <!-- <div class="line-remark">
                 <div class="remark-cap ps-2">
                     REMARKS:
                 </div>
